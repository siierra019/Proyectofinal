...
<header>
    <div class="container-fluid pt-3 pb-2 text-white text-center" id="encabezado">
      ...
      <div class="offcanvas offcanvas-start navbar-light text-center" id="offcanvasMenus" style="width: 200px; ">
        ...
        <br>
        <!--primer enlace-->
        <a href="login.html" class="link-dark rounded">Iniciar SesiÃ³n</a>
...
<br><br>
  ...
  <form action="ServletForm" method="POST" style="padding-left: 10%; padding-right: 10%;">

    <div class="input-group mb-3" style="background-color: white;">


      <span class="input-group-text">IDCompañía</span>
      <input type="text" class"form-control" name="IDcompania">

    </div>

    <div class="input-group mb-3" style="background-color: white;">
      <span class="input-group-text">Aeropuero Salida</span>
      <input type="text" class"form-control" name="ASalida">
        <span class="input-group-text">Aeropuerto Llegado</span>
      <input type="text" class"form-control" name="ALlegada">
    ...
    <div class="input-group mb-3" style="background-color: white;">
     ...
     <div class="input-group mb-3" style="background-color: white;">
      ...
      <input type="text" class"form-control" name="FSalida">
        <span class="input-group-text">Feca llegada</span>
      <input type="text" class"form-control" name="FLlegada">
    ...
    <div class="input-group mb-3" style="background-color: white;">
      ...
      <input type="text" class"form-control" name="Pviaje">
