...
<div class="marco2">
  <div class="titulito">
    <br><br>
    <h5 style="text-shadow: #555 2px 2px 3px;">Vuelos en globo en Madrid</h5>
    <br><br>
<p>Villanueva de la Cañada - Madrid</p>
  </div>
  <div class="imagenes">
    <img src="globo.jpg" alt="" width="100%" height="100%" >
    <br><br>
    <a href="pedido.jsp" style= "color: red;"><strong>140 eur</strong></a>
  </div>
...
<div class="marco2">
  <div class="titulito">
    <br><br>
    <h5 style="text-shadow: #555 2px 2px 3px;">Vuelo en avioneta</h5>
    <br><br>
    <p> Aeródromo Eduardo Castellanos de Villacastin</p>
<p>Madrid</p>

  </div>
  <div class="imagenes">
    <img src="avioneta.jpg" alt="" width="100%" height="100%">
    <br><br>
    <a href="pedido.jsp" style= "color: red;"><strong>100 eur</strong></a>
  </div>
