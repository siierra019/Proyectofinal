...
<div class="marco2">
  <div class="titulito">
    <br><br>
    <h5 style="text-shadow: #555 2px 2px 3px;">Escapada romántica con terraza y spa privados en Begur</h5>
    <br><br>
    <p>Mas Ses Vinyes (Adults Only)</p>
<p>Begur, Cataluña, España</p>
  </div>
  <div class="imagenes">
    <img src="escapada2.jpg" alt="" width="100%" height="100%" >
    <br><br>
   <a href="login.jsp" style="color: red;"> <p>1 noche, para 2 desde <strong>138 eur</strong>  noche</p></a>
  </div>
...
<p>París, Region de París, Francia</p>

  </div>
  <div class="imagenes">
    <img src="escapadaparis.jpg" alt="" width="100%" height="100%" >
    <br><br>
    <a href="login.jsp" style="color: red;"><p>1 noche, para 2 desde <strong>254 eur</strong>  noche</p></a>
  </div>
