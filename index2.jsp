...
<header>
    <div class="container-fluid pt-3 pb-2 text-white text-center" id="encabezado">
      ...
      <nav class="navbar navbar-expand-sm bg-red navbar-dark">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="index2.jsp" class="nav-link active">Inicio</a>
          </li>
          <li class="nav-item">
            <a href="Vuelo2.jsp" class="nav-link btn-cursor">Vuelos</a>
          </li>
          <li class="nav-item">
            <a href="Hoteles2.jsp" class="nav-link btn-cursor2">Hoteles</a>
          </li>
          <li class="nav-item">
            <a href="guias2.jsp" class="nav-link btn-cursor3">Guías</a>
          </li>
          <li class="nav-item">
...
<div class="marco2">
<br><br><br>
<h4>"Agencias ASI, lo hacemos <h4 style="color: red;">ASÍ"</h4></h4>
<br><br>
<h2 style=" text-shadow: 0 1px 0 #ccc,
               ...
               0 20px 20px rgba(0,0,0,.15);"><strong>¿Quiénes somos?</strong></h2>
<br>
<br>
<p>Somos una empresa dedicada a ayudarte a conocer mundo buscando los mejores vuelos para ti.</p>
<br>
<p>En esta empresa encontrarás los mejores viajes y las mejores aventuras a precios de</p>
<p>escándalo sin tener que preocuparte de nada más que hacer un simple click.</p>
<br>
<p>Te ofrecemos vuelos y hoteles con sus valoraciones, guías que te ayudarán a tener</p>
<p>una mejor experiencia y paquetes ya preparados para que no tengas que estar buscándote la vida.</p>
<br><br>
<p>¡DISFRÚTANOS!</p>
<br><br><br><br>
</div>
...
<div class="marco2">
  <br><br><br><br>
<img src="reseña.JPG" alt="" height="70%" width="70%">
<br><br><br><br>
</div>
